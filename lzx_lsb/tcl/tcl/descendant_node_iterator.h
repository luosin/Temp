...
#else
  : public std::iterator<std::bidirectional_iterator_tag, tree_type, std::ptrdiff_t, pointer_type, reference_type>
#endif
{
public:
...
#else
  : public std::iterator<std::forward_iterator_tag, tree_type, std::ptrdiff_t, pointer_type, reference_type>
#endif
{
public:
  // constructors/destructor
