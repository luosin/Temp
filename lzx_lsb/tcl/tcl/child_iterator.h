...
#else
  : public std::iterator<std::bidirectional_iterator_tag, stored_type, std::ptrdiff_t, pointer_type, reference_type> 
#endif
{
public:
...
#else
  : public std::iterator<std::random_access_iterator_tag, stored_type, std::ptrdiff_t, pointer_type, reference_type> 
#endif
{
public:
  // constructors/destructor
