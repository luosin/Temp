...
template< bool f > struct static_assert_greta;
template<>         struct static_assert_greta<true> { static_assert_greta() {} };
...
public:
    ...
    ~hetero_stack() // throw()
    {
        ...
        detail::static_assert_greta< detail::is_power_of_two<AlignmentT>::value > const align_test;
    ...
    inline void push( T const & t ) // throw(std::bad_alloc,...)
    {
        ...
        detail::static_assert_greta<( AlignmentT >= detail::alignof<T>::value )> const align_test;
    ...
    {
        detail::static_assert_greta< RuntimeTypeCheckT > const type_check;
